...
master = mavutil.mavlink_connection('127.0.1.1:14550', baud = 57600)
...
class VideoStream:
    ...
    def __init__(self,resolution=(144,144),framerate=30):
...
#             print(contador_persona)
        ...
        if(contador_persona >= 150): #150 - 3 seg         250 - 4 seg
            found_match = 0
            contador_persona = 0
            print("person NO")
